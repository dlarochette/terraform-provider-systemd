...
The catalog covers 232 directives from systemd v257 ([Unit], [Install], [Swap] and the
...
|-----------|----------|-------------|
| `name` | Required | Unit filename ending with `.swap`. Forces replacement when changed. |
...
- [systemd.swap](https://www.freedesktop.org/software/systemd/man/latest/systemd.swap.html)
